    ...
    <section className="relative overflow-hidden bg-black py-28 text-white">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-14 px-6 text-center">
          <h2 className="text-4xl font-semibold uppercase tracking-[0.3em] sm:text-5xl">
            Featured Work
          </h2>
          ...
          >
            {projects.map((project, index) => (
              <Link
                ...
                className="group relative min-w-[320px] overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.03] sm:min-w-[500px]"
              >
                <div className="relative flex h-[240px] items-center justify-center bg-black sm:h-[420px]">
                  ...
                  <div className="absolute bottom-0 left-0 p-8">
                    ...
                    <h3 className="mt-3 text-2xl font-semibold uppercase tracking-[0.15em] sm:text-4xl">
                      {project.title}
                    </h3>
                  </div>
